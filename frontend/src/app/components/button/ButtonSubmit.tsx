        ...
        >
            {btnLoading && (
                <div className="w-5 h-5 mx-auto animate-spin">
                    {/* <img src="/loading-icon.png" alt="loading" className="w-full h-full object-contain" /> */}
                    <AiOutlineLoading3Quarters className="w-full h-full object-contain" color="white" />
                </div>
            )}
            ...
            {!btnLoading && (
                <div className="flex justify-center items-center gap-x-1">
                    {btnIcon ?? ""}
                    {!iconOnly ? btnText : <span className="sr-only">Button Input</span>}
                </div>
            )}
        </button>
    )
